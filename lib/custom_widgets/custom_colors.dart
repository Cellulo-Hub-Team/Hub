...
class CustomColors {
  static Color redColor() => Common.contrastTheme
      ? MaterialColor(0x000000, _contrastedRedMap).shade900
      : MaterialColor(0x000000, _redMap).shade900;
  static Color greenColor() => Common.contrastTheme
      ? MaterialColor(0x000000, _contrastedGreenMap).shade900
      : MaterialColor(0x000000, _greenMap).shade900;
  static Color blueColor() => Common.contrastTheme
      ? MaterialColor(0x000000, _contrastedBlueMap).shade900
      : MaterialColor(0x000000, _blueMap).shade900;
  static Color yellowColor() => Common.contrastTheme
      ? MaterialColor(0x000000, _contrastedYellowMap).shade900
      : MaterialColor(0x000000, _yellowMap).shade900;
  static Color purpleColor() => Common.contrastTheme
      ? MaterialColor(0x000000, _contrastedPurpleMap).shade900
      : MaterialColor(0x000000, _purpleMap).shade900;
  ...
  static Color inversedDarkThemeColor() =>
      Common.darkTheme ? blackColor : Colors.white;
}
