...
class Style{
  static TextStyle titleStyle() => GoogleFonts.fredokaOne(fontSize: 30, color: Custom.darkTheme ? Colors.white : Colors.grey.shade700);
  ...
  static TextStyle descriptionStyle() => GoogleFonts.comfortaa(fontSize: 20, color: Custom.darkTheme ? Colors.white : Colors.grey.shade700);
